// =======================================================================
// PAUSE / RESUME
// Toggles the gamePaused flag; all game loops check this at the top.
// =======================================================================

function togglePause() {
  gamePaused = !gamePaused;
  document.getElementById("btnPause").innerHTML = gamePaused
    ? "&#9654; Resume"
    : "&#10074;&#10074; Pause";
}
...
function makeClipper() {
  ...
  document.getElementById("clipperCost").innerHTML = clipperCost.toLocaleString(
    undefined,
    { minimumFractionDigits: 2, maximumFractionDigits: 2 },
  );
}
